...
Purpose: Wallet Initialisation and interactions within the d-application
*/
...
export const initializeUserWallet = () => {
    if (!window.ethereum) {
        throw new Error("Ethereum object not found on window. Ensure MetaMask is installed.");
    }
